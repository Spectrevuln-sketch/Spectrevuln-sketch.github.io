        ...
        <div class="card-header">
          ...
          <div class="card-body">
            <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
              ...
              <div class="form-row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-user text-muted py-4" id="password1" type="text" name="password1" placeholder="Enter password" aria-describedby="passwordHelpInline" /></div>
              ...
              <div type="submit" class="form-group mt-4 mb-0">
          ...
          <div class="card-footer text-center">
            ...
            <div class="small"><a href="<?= base_url('user/dashboard'); ?>">FOR Persentation JUST TEST</a></div>
          </div>
        </div>
      </div>
    </div>
