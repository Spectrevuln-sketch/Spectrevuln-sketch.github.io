      ...
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-5 col-md-6">
          <div class="about_image">
            <img src="<?= base_url('assets'); ?>/img/about/about2.png" alt="Responsive image">
          </div>
        </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-xl-5 col-md-6">
        <div class="call_add_action">
          <a href="#" class="boxed-btn3"><?= $phone; ?></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-4 col-md-6">
        <div class="single_transport">
          <div class="icon">
            <img src="<?= base_url('assets/'); ?>img/svg_icon/live.png" alt="">
          </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-6">
        <div class="single_transport">
          <div class="icon">
            <img src="<?= base_url('assets/'); ?>img/svg_icon/world.png" alt="">
          </div>
